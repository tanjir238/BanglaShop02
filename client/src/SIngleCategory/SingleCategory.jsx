...
const SingleCategory = () => {
    ...
    if (cat === 'Text_Books') {
        ...
        productFilter.push('All', 'Child', 'Old', 'price low to high', 'price high to low', 'high rated', 'low rated')
    }
    else if (cat === 'Islamic_Books') {
        productFilter.push('Non-Academic', 'Academic', 'price low to high', 'price high to low', 'high rated', 'low rated')
    }
